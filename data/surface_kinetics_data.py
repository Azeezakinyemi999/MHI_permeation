...
- θ = surface coverage (fraction of occupied sites, 0 ≤ θ ≤ 1)
- S = empty surface site
- k_diss, k_recomb follow REFERENCE-TEMPERATURE Arrhenius form:
...
Units:
------
- T_ref: K - Reference temperature (800°C = 1073.15 K standard)
- k_diss_ref: m⁴/(mol·s) - dissociation rate constant at T_ref
- k_recomb_ref: m²/s - recombination rate constant at T_ref
- E_diss: J/mol - dissociation activation energy
- E_recomb: J/mol - recombination activation energy
- N_surf: m⁻² - surface site density (sites per unit area)
...
# =============================================================================
# SURFACE KINETICS PARAMETERS (Reference-Temperature Arrhenius Format)
# =============================================================================
...
SURFACE_KINETICS = {
    ...
    'Incoloy800': {
        ...
        # k(T) = k_ref × exp((-E/R) × (1/T - 1/T_ref))
        'k_diss_ref': 1.70e-3,   # m⁴/(mol·s) at 800°C
        'k_recomb_ref': 1.55e-11, # m²/s at 800°C
    ...
    'Fe_alpha': {
        ...
        'k_diss_ref': 1.65e-2,   # m⁴/(mol·s) at 800°C
        'k_recomb_ref': 2.17e-12, # m²/s at 800°C
    ...
    'Ni': {
        ...
        'k_diss_ref': 2.14e-4,   # m⁴/(mol·s) at 800°C
        'k_recomb_ref': 1.23e-12, # m²/s at 800°C
    ...
    'SS316L': {
        ...
        'k_diss_ref': 6.51e-4,   # m⁴/(mol·s) at 800°C
        'k_recomb_ref': 4.49e-12, # m²/s at 800°C
...
def get_surface_kinetics(material_name, temperature):
    ...
    Uses reference-temperature Arrhenius form:
        k(T) = k_ref × exp((-E/R) × (1/T - 1/T_ref))
    ...
    # Calculate rate constants using reference-temperature Arrhenius form
    # k(T) = k_ref × exp((-E/R) × (1/T - 1/T_ref))
    k_diss = params['k_diss_ref'] * np.exp(
        (-params['E_diss'] / R_GAS) * (1/temperature - 1/T_ref)
    )
    k_recomb = params['k_recomb_ref'] * np.exp(
        (-params['E_recomb'] / R_GAS) * (1/temperature - 1/T_ref)
    )
